...
def get_stylize(contentPath, stylePath, alpha=0.6):
  ...
  csF = torch.Tensor()
  csF = Variable(csF)
  stylePath = r"H:\软件下载区\Super_computer\pytorch-in-flask-master\pytorch-in-flask-master\server\styles\2.jpg"
...
if __name__ == '__main__':
  ...
  get_stylize(r'output/contents/广西大学.jpg', r'output/contents/广西大学.jpg')
